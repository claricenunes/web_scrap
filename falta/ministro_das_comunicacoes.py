...
def get_minister_info():
    url = "https://www.gov.br/mcom/pt-br/composicao/ministro"
    headers = {
    ...
    # Initialize data
    name = "N/A"
    cargo = "Ministro de Estado das Comunicações"
    phone = "N/A"
    email = "N/A"
    ...
    if title_tag:
        ...
        # Title format: "Frederico de Siqueira Filho — Ministério das Comunicações"
        if "—" in title_text:
    ...
    if content:
        ...
        # Look for pattern like: (61) 2027 6706/6863/6889/6940
